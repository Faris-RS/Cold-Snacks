      ...
      <div class="bg-blue-100 py-20">
        <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
          <div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
            <h1 class="text-3xl md:text-5xl p-2 text-green-400 tracking-loose">
              TechFest
            </h1>
            ...
            <a
              href="#"
              class="bg-transparent hover:bg-green-400 text-green-400 hover:text-black duration-300 ease-in-out rounded shadow hover:shadow-lg py-2 px-4 border border-green-400 hover:border-transparent"
            >
              Explore Now
            </a>
          </div>
