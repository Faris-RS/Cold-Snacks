...
export default function ProductModal() {
  return (
    <div class="min-w-screen min-h-screen bg-green-300 flex items-center p-5 lg:p-10 overflow-hidden relative">
          ...
          <div class="w-full md:w-1/2 px-10">
            ...
            <div>
              ...
              <div class="inline-block align-bottom">
                <button class="bg-blue-300 opacity-75 hover:opacity-100 text-blue-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold">
